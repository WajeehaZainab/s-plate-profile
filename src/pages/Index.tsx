        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <Link to="/contact">
              <Button 
                variant="ghost" 
                className="text-amber-600 hover:text-amber-700 hover:bg-amber-50 text-sm md:text-base font-medium"
              >
      ...
      <section className="py-12 md:py-20 px-4 bg-gray-50">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Award Image */}
            <Card className="overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-300 bg-white p-0 h-[540px] md:h-[600px]">
              <div className="relative w-full h-full overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6 z-10">
                  ...
                  <h3 className="text-lg md:text-xl font-bold mb-2 text-white leading-tight">Culinary Excellence Award</h3>
                  <p className="text-sm md:text-base text-white/90 leading-relaxed">Outstanding achievements in Oriental cuisine</p>
                </div>
              </div>
            </Card>

            {/* LinkedIn Post */}
            <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white h-[540px] md:h-[600px] flex flex-col">
              <CardContent className="p-4 md:p-5 flex flex-col h-full">
                ...
                <p className="text-xs md:text-sm text-gray-700 mb-3 leading-relaxed">
                  Featured masterclass at FFCC Dubai 2025 showcasing culinary excellence.
                </p>
            ...
            {/* Chef Michel Roth Instagram Post */}
            <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white h-[540px] md:h-[600px] flex flex-col">
              <CardContent className="p-4 md:p-5 flex flex-col h-full">
                <div className="flex items-center gap-2.5 mb-3">
                  ...
                  <div className="min-w-0">
                    <p className="font-semibold text-gray-900 text-sm md:text-base leading-tight">Star Moment</p>
                    <p className="text-xs md:text-sm text-gray-500 leading-tight">@chefmichelroth</p>
                  </div>
                </div>
                
                <div className="overflow-hidden rounded-lg mb-3 flex-grow min-h-0">
                  <img 
                    src="/StarMoment-2.jpg" 
                    alt="With Chef Michel Roth" 
                    className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"
                  />
                </div>
                
                <p className="text-xs md:text-sm text-gray-700 mb-3 leading-relaxed">
                  Honored to meet with Michelin Star Chef Michel Roth.
                </p>
                
                <a 
                  href="https://www.instagram.com/chefmichelroth?igsh=aDlqZnFscGNkaG9z" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="mt-auto flex-shrink-0"
                >
            ...
            <Card className="overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-white h-[540px] md:h-[600px] flex flex-col">
              <CardContent className="p-4 md:p-5 flex flex-col h-full">
                ...
                <p className="text-xs md:text-sm text-gray-700 mb-3 leading-relaxed">
                  Proud moment receiving culinary excellence recognition.
                </p>
